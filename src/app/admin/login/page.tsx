        ...
        <main className='bg-primary h-screen flex items-center justify-center p-6'>
            <div className='border py-5 px-4 sm:px-8 sm:w-[25rem] bg-white rounded-lg flex flex-col justify-center items-center gap-3'>
                ...
                <form action="#" className='w-full' onSubmit={handleSubmit}>
                    ...
                    <input type="text" placeholder='Email' id='email' className='border w-full h-12 mt-2 rounded mb-5 p-3 text-sm' value={values.email} onChange={handleChange}/><br />

                    <label htmlFor="password" className='text-sm'>Password</label><br />
                    <input type="password" placeholder='Password' id='password' className='border w-full h-12 mt-2 rounded p-3 text-sm' value={values.password} onChange={handleChange}/>
